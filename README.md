...
- 學習工具：摘要、測驗生成與作答、心智圖、閃卡與間隔複習、錯題本、筆記、學習目標；測驗、心智圖、閃卡生成會以 Celery 背景任務保存進度，功能頁可點擊查看階段進度，離開頁面後仍會完成並回寫資料庫；Markdown 與心智圖節點文字支援 LaTeX/KaTeX 顯示。
- 課程功能：教師建立課程、加入碼、成員角色、文件共享、教材批次加入與移除、多選整課問答/測驗/閃卡、公告、作業、含聊天脈絡的求助佇列、可編輯設定的課程測驗、預設核准題庫與學習進度。
- Admin 後台：使用者、文件、對話、課程、LLM 設定、成本統計、可靠性事件、全站生成任務狀態、稽核紀錄、資料刪除管理。
- 角色化 UI：全站側欄依學習、課程、管理、帳號分區，儀表板依學生、教師、管理者顯示常用入口與個人生成任務狀態。
